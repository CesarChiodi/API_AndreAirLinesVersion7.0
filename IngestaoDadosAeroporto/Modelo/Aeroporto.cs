...
namespace IngestaoDadosAeroporto.Modelo
{
    public class Aeroporto
    {
        ...
        public readonly static string GETID = "SELECT Id, City, Country, Code, Continent FROM Aeroporto WHERE Id";
        ...
        public Aeroporto(string city, string country, string code, string continent)
        {
            City = city;
            Country = country;
            Code = code;
